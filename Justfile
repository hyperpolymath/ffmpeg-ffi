...
doctor:
    @echo "Running diagnostics for ffmpeg-ffi..."
...
help-me:
    @echo "=== ffmpeg-ffi Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/ffmpeg-ffi/issues/new"
    @echo ""
