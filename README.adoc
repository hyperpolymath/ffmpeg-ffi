link:LICENSE[image:https://img.shields.io/badge/license-PMPL--1.0--or--later-blue[License]]
image:https://img.shields.io/badge/lang-Zig-F7A41D[Zig]
image:https://img.shields.io/badge/lang-Idris2-red[Idris2]
image:https://img.shields.io/badge/ABI--FFI-Idris2%2FZig-brightgreen[ABI-FFI
Standard]
https://github.com/hyperpolymath/ffmpeg-ffi/actions/workflows/hypatia-scan.yml[image:https://github.com/hyperpolymath/ffmpeg-ffi/actions/workflows/hypatia-scan.yml/badge.svg[Hypatia
Scan]]
...
subprocess calls to `+ffprobe+`/`+ffmpeg+`. It replaces the typical C
header approach with direct `+extern+` `+"C"+` declarations and a thin
...
link:LICENSE[Palimpsest License (MPL-2.0)]
